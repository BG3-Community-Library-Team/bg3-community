...
This character exists in both the Level files, and the Character RootTemplates. It haas not yet been tested to see which IDs are used for the NPC found in game, so both variations for each are listed here.
- IsGlobal: `True`
