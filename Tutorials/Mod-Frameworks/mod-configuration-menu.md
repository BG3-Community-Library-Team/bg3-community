...
On top of it all, if you currently offer multiple mod versions with different code to avoid providing settings, you can simplify this by using MCM to introduce settings. This way, you can avoid creating and maintaining several different .pak versions for your mods.
