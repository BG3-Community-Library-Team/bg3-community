...
- [BG3 Armature Tools](https://www.nexusmods.com/baldursgate3/mods/464) (note if using **Blender 4+** to use the updated plugin)
...
Let’s first do some cleanup to make sure the internal bones are placed right. If they are off you could get cutscene weirdness like piercings flying off or very comical expressions (even for Tav).

1)

**The base bones, the gesture bones, and the wrinkle bones.(recommended)**
...
Export as GR2. Go with default settings, but use “selected objects”
