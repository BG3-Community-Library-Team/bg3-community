...
> This method is the "manual" method--it doesn't involve using the official toolkit. 
For the toolkit method, see this page: [Creating Custom Origins In Toolkit](/Tutorials/Toolkit/Creating-Custom-Origins)
{.is-info}
