...
`>SampleMod\Generated\Public\SampleMod\Assets\HUM_F_NKD_Head_Example.GR2
`
You can then hotload it by creating this filepath in your BG3 Data directory:

`C:\Program Files (x86)\Steam\steamapps\common\Baldurs Gate 3\Data\Generated\Public\SampleMod\Assets\HUM_F_NKD_Head_Example.GR2`
...
> Keep in mind, if you have `meta.lsx` of the mod that you are hotloading in your `Data/Mods/modname`, the game will pull the files from the pak instead of pulling the hotloaded ones
{.is-warning}
